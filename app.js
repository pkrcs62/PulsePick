...
async function refresh(){
  ...
  try{
    ...
    $("refreshStatus").textContent="Loading the NSE stock list…";
    await loadUniverse();
    $("refreshStatus").textContent="Fetching live prices…";
...
loadUniverse().then(()=>render()).catch(()=>{})
